    ...
    <section className="relative py-28 px-6 overflow-hidden">
      ...
      <div className="container mx-auto relative">
        ...
        <div className="space-y-24">
          {/* Abhidh Academy */}
          <div id="academy" className="grid lg:grid-cols-2 gap-12 items-stretch">
            <div className="order-2 lg:order-1">
              <img
                src={academyHero}
                alt="Abhidh Academy - Professional Training and Education"
                className="rounded-3xl shadow-[0_45px_80px_-40px_rgba(18,40,90,0.55)] w-full h-full min-h-[500px] object-cover border border-white/10"
              />
            </div>
            <div className="order-1 lg:order-2 space-y-6 bg-card/60 backdrop-blur-xl rounded-3xl border border-white/10 p-10 shadow-[0_35px_70px_-40px_rgba(12,24,64,0.6)] flex flex-col">
          ...
          {/* Abhidh Creative */}
          <div id="creative" className="grid lg:grid-cols-2 gap-12 items-stretch">
            <div className="space-y-6 bg-card/60 backdrop-blur-xl rounded-3xl border border-white/10 p-10 shadow-[0_35px_70px_-40px_rgba(12,24,64,0.6)] flex flex-col">
